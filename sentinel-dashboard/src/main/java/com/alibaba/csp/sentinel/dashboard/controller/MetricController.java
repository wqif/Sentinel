...
public class MetricController {
    ...
    @Resource
    private MetricsStoreProperties metricsStoreProperties;
    ...
    public Result<?> queryTopResourceMetric(final String app,
        ...
        if (startTime == null) {
            ...
            startTime = endTime - metricsStoreProperties.getMaxQueryIntervalTime().toMillis();
        }
        long maxQueryIntervalMs = metricsStoreProperties.getMaxQueryIntervalTime().toMillis();
