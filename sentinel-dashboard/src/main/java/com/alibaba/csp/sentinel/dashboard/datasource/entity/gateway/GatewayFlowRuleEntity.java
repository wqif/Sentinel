...
public class GatewayFlowRuleEntity implements RuleEntity {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, that.id) &&
                ...
                Objects.equals(intervalSec, that.intervalSec) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, app, ip, port, gmtCreate, gmtModified, resource, resourceMode, grade, count, interval, intervalUnit, intervalSec, controlBehavior, burst, maxQueueingTimeoutMs, paramItem);
    }
